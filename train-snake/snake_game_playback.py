...
def runGame(generation, nn_shape=[24,30,30,4], activation_functions=['tanh','tanh','softmax'], watch=True):
    ...
    net_files=glob.glob('ga_snake_history/best/*.h5')
    net_files=[i.split('\\')[-1] for i in net_files]
    
    nets=[]
    #Manually compile the best neural net from each generation
